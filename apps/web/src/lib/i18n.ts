...
export const uiDictionary: Record<Language, UiDictionary> = {
  zh: {
    ...
    chatPlaceholder: "例如：右下牙疼两天了，晚上更疼，还没拍片",
    chatSending: "发送中...",
    chatSend: "发送",
    chatOpen: "AI 问诊",
    ...
    chatWelcome: "你好，我是泉寓门诊的 AI 导诊助手。你可以先告诉我你的症状、持续多久了、是否疼痛或出血。",
    backToTop: "返回顶部",
  },
  ru: {
    langLabel: "Язык",
    ...
    chatPlaceholder: "Например: болит нижний правый зуб уже два дня, ночью сильнее, снимков пока нет",
    ...
    chatWelcome: "Здравствуйте, я AI-ассистент клиники «Цюаньюй». Опишите симптомы, длительность, наличие боли или кровоточивости.",
    backToTop: "Наверх",
  },
  en: {
    langLabel: "Language",
    ...
    chatPlaceholder: "For example: lower right tooth has been painful for two days, worse at night, no imaging yet",
    chatSending: "Sending...",
    chatSend: "Send",
    chatOpen: "AI Triage",
    ...
    chatWelcome: "Hello, I am the AI triage assistant for Quanyu Clinic. Please tell me your symptoms, how long they have lasted, and whether you have pain or bleeding.",
